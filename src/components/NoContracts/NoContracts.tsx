    ...
    <NoContractsWrapper>
      <div className="contracts__wrap">
        <div className="grid-x grid-margin-x contracts__container">
          <div className="cell grid-x small-5 xlarge-45 contracts__cell">
            <div className="contracts__image_wrap">
              <img className="contracts__image" src="/img/main/share.svg" alt="mining24" />
            </div>
          </div>
          <div className="cell grid-x small-7 xlarge-75 contracts__cell">
